namespace FinalProject.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Zoom = c.Double(nullable: false),
                        Lattitude = c.Double(nullable: false),
                        Longtidute = c.Double(nullable: false),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Enters", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Enters", "ArticleId", "dbo.Articles");
            ...
            DropIndex("dbo.Enters", new[] { "UserId" });
            DropIndex("dbo.Enters", new[] { "ArticleId" });
